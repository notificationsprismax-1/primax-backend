...
if (process.env.PGPASSWORD) console.log("PGPASSWORD starts with:", process.env.PGPASSWORD.substring(0, 4));
...
if (process.env.DATABASE_URL) {
  ...
  try {
    ...
    console.log(`DATABASE_URL Pass starts with: ${parsed.password ? parsed.password.substring(0, 4) : 'NONE'}`);
  } catch (e) {}
} else {
  console.log("DATABASE_URL is MISSING completely!");
}
console.log("========================");
